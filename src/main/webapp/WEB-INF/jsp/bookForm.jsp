<%-- 
    Document   : book-form
    Created on : 26 Jun 2023, 23:36:20
    Author     : adityaillur
--%>
...
<html lang="en">
    ...
    <body>
        <div class="container">
            <h1 class="title">Add a New Book Form</h1>
            <form:form modelAttribute="book" action="add.htm" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="bkisbn">ISBN:</label>
                    <form:input path="bkisbn"/>
                    <form:errors path="bkisbn" cssClass="error-message"/>
                </div>

                <div class="form-group">
                    <label for="bktitle">Book Title:</label>
                    <form:input path="bktitle"/>
                    <form:errors path="bktitle" cssClass="error-message"/>
                </div>

                <div class="form-group">
                    <label for="bkauth">Author:</label>
                    <form:input path="bkauth"/>
                </div>
